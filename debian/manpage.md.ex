% zxnimage(SECTION) | User Commands
%
% "January 30 2023"
...
zxnimage - program to do something

# SYNOPSIS

**zxnimage** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**zxnimage** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **zxnimage** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**zxnimage** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    zxnimage. See **foo.conf**(5) for further details.
...
**zxnimage** provides some return codes, that can be used in scripts:
...
Copyright © 2007 Theodore (Alex) Evans
